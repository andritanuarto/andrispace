...
const caseStudyContent = (
  <>
    <div className="par par--normal-width">
      ...
      <p>
        <h3>Problems</h3>
        We got some feedback from customers to improve the functionality and the visibility of the overall plan view. Especially when the planning gets bigger, users were having a hard time finding items that buried inside on the lower level of the plan. Some visual alternative and quick ways to find items could potentially improve the usability of the software.
      </p>
    </div>
  </>
);
